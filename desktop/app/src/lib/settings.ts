...
export function settingsRows(apple: boolean): SettingsRow[] {
    return [
        ...
        {
            id: 'general:spectrum-delay',
            category: 'general',
            label: 'Spectrum delay',
            description: 'Sound over Bluetooth arrives after the bars do. This holds them back to meet it.',
            keywords: [
                'bluetooth',
                'latency',
                'lag',
        ...
        },
        {
            ...
            category: 'theme',
            label: 'Palette',
            // The spectrum's ramp comes with the palette rather than being chosen apart from it,
            // so the words somebody would look for it under have to land on this row.
            keywords: [
                'palette',
                'theme',
                'colour',
