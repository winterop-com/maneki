...
function safeAdd(a: any, b: any): any {
  const lsw = (a & 0xffff) + (b & 0xffff);
  const msw = (a >> 16) + (b >> 16) + (lsw >> 16);
  return (msw << 16) | (lsw & 0xffff);
}

function rotateLeft(x: any, n: any): any {
  return (x << n) | (x >>> (32 - n));
}

function md5cmn(q: any, a: any, b: any, x: any, s: any, t: any): any {
  return safeAdd(rotateLeft(safeAdd(safeAdd(a, q), safeAdd(x, t)), s), b);
}
function md5ff(a: any, b: any, c: any, d: any, x: any, s: any, t: any): any {
  return md5cmn((b & c) | (~b & d), a, b, x, s, t);
}
function md5gg(a: any, b: any, c: any, d: any, x: any, s: any, t: any): any {
  return md5cmn((b & d) | (c & ~d), a, b, x, s, t);
}
function md5hh(a: any, b: any, c: any, d: any, x: any, s: any, t: any): any {
  return md5cmn(b ^ c ^ d, a, b, x, s, t);
}
function md5ii(a: any, b: any, c: any, d: any, x: any, s: any, t: any): any {
  return md5cmn(c ^ (b | ~d), a, b, x, s, t);
}

function md51(s: any): any {
...
function md5cycle(state: any, x: any): any {
  let [a, b, c, d] = state;
