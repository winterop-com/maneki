...
from mediakit.audio.convert import DEFAULT_LOSSY_BITRATE, OutputFormat
from mediakit.audio.discover import discover_albums
from mediakit.audio.pipeline.album import _process_album
from mediakit.audio.pipeline.progress import ProgressContext
from mediakit.audio.pipeline.report import AlbumReport, _print_summary
...
def run(
    ...
    *,
    ...
    if enrich is None:
        from mediakit.audio.enrich._http import is_online
