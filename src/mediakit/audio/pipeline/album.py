...
from mediakit.audio import convert, naming
from mediakit.audio import cover as cover_mod
from mediakit.audio.convert import OutputFormat
from mediakit.audio.cover import Cover
from mediakit.audio.discover import AlbumDir
from mediakit.audio.metadata import MusicBrainzIds, SourceTrack, clean_album_title, read_source, summarize_album
from mediakit.audio.pipeline.acoustid import _enrich_with_acoustid
from mediakit.audio.pipeline.dedupe import _dedupe_duplicate_tracks
from mediakit.audio.pipeline.disc import _maybe_apply_filename_disc_track, _maybe_apply_scene_encoded_disc_track
from mediakit.audio.pipeline.filenames import _parse_filename_for_va, _track_no_from_filename
from mediakit.audio.pipeline.footprint import _input_footprint
from mediakit.audio.pipeline.progress import ProgressContext
from mediakit.audio.pipeline.report import AlbumReport
from mediakit.audio.pipeline.track import _planned_filename, _process_track, _resolve_track_metadata, _ResolvedTrack
...
def _process_album(
    ...
    if enrich:
        from mediakit.audio.enrich import run_enrichment
