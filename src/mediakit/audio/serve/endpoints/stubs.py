...
from mediakit.audio.serve.app import envelope
...
@router.api_route("/getPodcasts.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/getNewestPodcasts.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/refreshPodcasts.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/createPodcastChannel.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/deletePodcastChannel.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/deletePodcastEpisode.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/getPlayQueue.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/savePlayQueue.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/getShares.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/createShare.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/updateShare.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/deleteShare.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/getChatMessages.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/addChatMessage.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/jukeboxControl.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/getSimilarSongs.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/getSimilarSongs2.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/getTopSongs.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/getAlbumInfo.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/getAlbumInfo2.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
# ---------------------------------------------------------------------------
# Now playing — multi-user feature; single-user mediakit is always empty
# ---------------------------------------------------------------------------
...
@router.api_route("/setRating.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/changePassword.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/createUser.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/updateUser.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/deleteUser.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
...
@router.api_route("/getAvatar.view", methods=["GET", "POST", "HEAD"], include_in_schema=False)
