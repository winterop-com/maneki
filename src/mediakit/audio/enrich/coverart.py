...
from mediakit.audio.cover import CoverCandidate, CoverSource
from mediakit.audio.enrich import EnrichmentResult
from mediakit.audio.enrich._http import get_client, throttled_get
from mediakit.audio.metadata import AlbumSummary, SourceTrack
...
class CoverArtArchiveProvider:
    ...
    def enrich(self, album: AlbumSummary, tracks: list[SourceTrack]) -> EnrichmentResult:
        ...
        # in `mediakit.audio.enrich.run_enrichment` handles that hand-off. When called
