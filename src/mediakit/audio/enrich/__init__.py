...
`mediakit cover-pick` command that opens it pre-filled for manual selection.
"""
...
from mediakit.audio.cover import CoverCandidate
from mediakit.audio.metadata import AlbumSummary, MusicBrainzIds, SourceTrack
...
def run_enrichment(album: AlbumSummary, tracks: list[SourceTrack]) -> EnrichmentResult:
    ...
    from mediakit.audio.enrich._http import get_client
