...
if TYPE_CHECKING:
    from mediakit.audio.tui.airplay import AirPlayDevice
...
class AirPlayPickerScreen(ModalScreen[None]):
    ...
    def __init__(self, app_ref: MediakitApp) -> None:
        super().__init__()
    ...
    def _populate(self, devices: list[AirPlayDevice]) -> None:
        ...
        if not devices:
            ...
            from mediakit.audio.tui.airplay import AirPlayDevice as _AirPlayDevice  # type: ignore[unused-ignore]
