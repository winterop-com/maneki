...
is `LibraryTrack.stream_url` — set here, read by `MediakitApp._play_current`
when present.
"""
...
class SubsonicClient:
    """Read-only Subsonic API client. Used by `mediakit tui --subsonic`.
    ...
    def star(self, item_id: str) -> None:
        ...
        Subsonic infers the kind from the id prefix on mediakit serve
