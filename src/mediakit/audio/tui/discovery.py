"""Browse `_subsonic._tcp.local` for mediakit servers on the LAN."""
...
class DiscoveredServer:
    ...
    name: str  # pretty (instance) name, e.g. `mediakit-mlaptop`
    ...
    def is_musickit(self) -> bool:
        """True when the advertisement's `type` TXT record says it's a mediakit serve."""
        return self.name.startswith("mediakit")
