...
class TopBar(Static):
    ...
    def render(self) -> str:
        ...
        return f"[bold cyan]mediakit[/] [dim]v{__version__}[/]"
...
class Visualizer(Static):
    ...
    Visualizer {
        ...
        /* Share the main column with the tracklist proportionally
           ...
           lives in `MediakitApp.CSS`, NOT here. Textual applies a
...
class TrackTableHeader(Static):
    ...
    def render(self) -> str:
        from mediakit.audio.tui.formatters import ARTIST_WIDTH, TIME_WIDTH, compute_title_width
