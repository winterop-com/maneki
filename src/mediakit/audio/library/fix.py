...
from mediakit.audio.library.models import LibraryAlbum, LibraryIndex
from mediakit.audio.library.scan import _split_dir_year
...
def fix_index(
    ...
    *,
    ...
    if year_lookup is None:
        from mediakit.audio.enrich.musicbrainz import lookup_release_year
