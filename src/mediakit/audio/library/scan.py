...
from mediakit.audio import naming
from mediakit.audio.library.models import LibraryAlbum, LibraryIndex, LibraryTrack
from mediakit.audio.lyrics import read_sidecar
from mediakit.audio.metadata import SUPPORTED_AUDIO_EXTS, read_source
...
def rescan_albums(
    ...
    *,
    ...
    """
    from mediakit.audio.library.audit import audit_album
    ...
    if removed or updated:
        from mediakit.audio.library.db import reclaim_freelist
