"""`mediakit cover-pick` — semi-automated cover sourcing via musichoarders.xyz.
...
from mediakit.audio.cover import DEFAULT_MAX_EDGE
from mediakit.audio.enrich.musichoarders import build_search_url
from mediakit.audio.library import LibraryAlbum
from mediakit.audio.metadata import SUPPORTED_AUDIO_EXTS, embed_cover_only
