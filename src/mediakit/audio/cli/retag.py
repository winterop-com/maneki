"""`mediakit library retag DIR` — override tags on every audio file under DIR in-place."""
...
from mediakit.audio.metadata import SUPPORTED_AUDIO_EXTS, TagOverrides, apply_tag_overrides, read_source
