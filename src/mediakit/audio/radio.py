...
Two sources merge at runtime:
  ...
  2. `~/.config/mediakit/radio.toml` — purely for the user's own additions.
...
_USER_TEMPLATE = """\
# mediakit radio stations — your custom additions go here.
#
...
def stations_path() -> Path:
    ...
    return Path.home() / ".config" / "mediakit" / "radio.toml"
