...
def write_mp4_tags(
    ...
    *,
    ...
    # iTunes-style "encoder" atom — read by `mediakit inspect`, ffprobe,
...
def embed_cover_only(path: Path, *, cover_bytes: bytes, cover_mime: str) -> None:
    ...
    Supports `.m4a/.mp4/.m4b`, `.mp3`, and `.flac`. Used by `mediakit cover`
