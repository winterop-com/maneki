...
`maneki cover-pick` command that opens it pre-filled for manual selection.
"""
...
from maneki.audio.cover import CoverCandidate
...
def run_enrichment(album: AlbumSummary, tracks: list[SourceTrack]) -> EnrichmentResult:
    ...
    from maneki.audio.enrich._http import get_client
