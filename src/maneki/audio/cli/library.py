...
def lyrics_fetch(
    ...
    from maneki.audio.lyrics import LrcLibClient, LrcLibError, sidecar_path
        ...
        for album, track in candidates:
            ...
            try:
                ...
                if payload is None:
                    ...
                    if body:
                        from maneki.audio.lyrics import write_sidecar
...
index_app = typer.Typer(
    no_args_is_help=True,
    help="Manage the persistent SQLite index DB at `<DIR>/.maneki/index.db`.",
)
