"""`maneki cover-pick` — semi-automated cover sourcing via musichoarders.xyz.
...
from maneki.audio.cli._scan import scan_with_progress
...
from maneki.audio.library import LibraryAlbum
from maneki.audio.metadata import SUPPORTED_AUDIO_EXTS, embed_cover_only
