...
from mediakit.audio.tui.subsonic_client import SubsonicClient, SubsonicError, build_index
...
def test_hydrate_album_tracks_populates_in_place(tmp_path: Path) -> None:
    ...
    from mediakit.audio.tui.subsonic_client import hydrate_album_tracks
