...
from mediakit.audio.tui.audio_engine import AudioEngine, SharedState
from mediakit.audio.tui.audio_proto import (
    SAMPLE_RATE,
    VIS_BANDS,
    Command,
    Event,
...
def test_replaygain_off_returns_unity_multiplier() -> None:
    from mediakit.audio.tui.player import compute_replaygain_multiplier
...
def test_stop_cancels_pending_async_open(monkeypatch: pytest.MonkeyPatch, fake_stream: type[_FakeOutputStream]) -> None:
    ...
    """
    from mediakit.audio.tui import audio_engine as engine_mod
